...
class Inferencer:
    def __init__(self, args):
        ...
        # 改为：
        if hasattr(self.model.module, 'load_fsg_weights'):
            self.model.module.load_fsg_weights(args.model_path)
        elif hasattr(self.model, 'load_fsg_weights'):
            self.model.load_fsg_weights(args.model_path)
        else:
            self.model.load_state_dict(torch.load(args.model_path))
        self.model.eval()
